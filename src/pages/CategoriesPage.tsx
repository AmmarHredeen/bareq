...
import { Plus, Tags, X, Filter } from 'lucide-react';
import {
    Button,
    Card,
    SearchBar,
...
export function CategoriesPage() {
    ...
    const handleSubmit = (values: CategoryFormValues) => {
        const input = {
            ...
            show_in_newsletter: values.is_active
                ? values.show_in_newsletter
                : false,
        };
        ...
        <div className="animate-fade-in space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                    <span className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-violet-600 text-white shadow-lg shadow-violet-500/25">
            ...
            <Modal
                ...
                title={selected ? 'تعديل الفئة' : 'إضافة فئة جديدة'}
            >
                <CategoryForm
            ...
            <ConfirmDialog
                ...
                message={`هل أنت متأكد من حذف فئة "${toDelete?.name}"؟`}
