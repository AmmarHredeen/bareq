...
const ACCENTS: Record<Accent, { on: string; icon: string; check: string }> = {
  emerald: {
      ...
      <div>
        ...
        <div className="space-y-2.5">
          <ToggleRow
            icon={Power}
            title="نشط"
            description="تفعيل العلامة في النظام"
            active={isActive}
            accent="emerald"
          ...
          {!isActive && (
            <p className="rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-700 ring-1 ring-inset ring-amber-100 dark:bg-amber-500/10 dark:text-amber-300 dark:ring-amber-500/20">
              العلامة غير نشطة — لن تظهر في التطبيق أو النشرة حتى يتم تفعيلها.
            </p>
          )}
          ...
          >
            <ToggleRow
              ...
              description="عرض العلامة داخل تطبيق العملاء"
            ...
            <ToggleRow
              ...
              description="تضمين العلامة في النشرة المطبوعة"
